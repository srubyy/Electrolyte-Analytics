...
router.post('/production/manager-approve', authenticateJWT, authorize(['Manager', 'Superadmin']), managerApproveLog);
router.post('/production/reject', authenticateJWT, authorize(['Team Lead', 'Manager', 'Superadmin']), rejectLog);
